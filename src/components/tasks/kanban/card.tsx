...
import { TextIcon } from '@/components/layouts/text-icon';
import {User} from '@/graphql/schema.types'
import {Button, Card, Dropdown, MenuProps, Space, Tooltip}from'antd'
          ...
          style={{
            ...
            {!!users?.length&&(
              ...
              style={{
                ...
                {users?.map((user)=>(
                  <Tooltip
                  key={user.id} title={user.name}>
                      <CustomAvatar
                      name={user.name} src={user.avatarUrl}/>
                  </Tooltip>
                ))
              }
              </Space>
